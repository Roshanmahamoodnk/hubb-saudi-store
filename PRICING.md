...
The cup's small price benefit leaves room for its additional outer pack and shell bag; the Family Mix creates a clearer sharing-value step. The case is a trade format with no cup/bucket accessory promise. Any claimed percentage is a mathematical comparison against the proposed single price; it is not a promotion against an established previous selling price. Do not show invented crossed-out former prices.
...
Research retrieval date: **6 September 2026**. This is a limited shelf-price scan of publicly accessible Saudi-facing retailer listings, not a market average, a physical shelf audit, a city-specific checkout or confirmed delivery availability. The web service can return previously crawled retailer content; crawl/fetch limitations are recorded below. Competitor product names support a category comparison, not proof of equal seed size, grade, flavour intensity or package engineering. No competitor images are needed in the HUBB site.

| Primary retailer and listing | Pack | Displayed SAR | Calculated SAR / 100 g | Observation and limits |
|---|---:|---:|---:|---|
| [Danube — Mehbaj salted sunflower seeds](https://danube.sa/en/products/mehbaj-sunflower-seeds-salted-85g) | 85 g | 4.99 | 5.87 | Retailer search extract retrieved today; recorded crawl “last month”. Direct page fetch returned 403, so the number was not independently refreshed through an open-page result. |
| [LuLu KSA — Baja sunflower seeds](https://gcc.luluhypermarket.com/en-sa/baja-sunflower-seeds-230-g/p/1485525) | 230 g | 9.95 | 4.33 | Directly opened retailer page returned 9.95. Search result said out of stock while the opened snapshot displayed Add to cart; availability is unresolved. Opened content reported a seven-month crawl age. |
| [LuLu KSA — roasted sunflower seeds](https://gcc.luluhypermarket.com/en-sa/sunflower-seed-roasted-250-g/p/1662213) | 250 g | 5.00 | 2.00 | Opened retailer result, final crawl indicator today. Out of stock. Roastery-format lower-price comparison, not a direct match to flavour sachets. |
...
The numbers above are not cost-based because no costs were supplied. Do not represent a margin, profitability or launch guarantee.

Record costs for finished flavoured seeds per kg; actual yield/loss; each printed sachet and filling operation; cup, lid, bucket, divider, retail case and shell bag; labour and quality testing; warehousing and damage; pick/pack; payment fee; delivery subsidy; retailer/distributor terms; returns; and any tax treatment. Validate each flavour's cost separately even if the recommended shelf prices match.
